...
from example_project.example_app.models import CustomUser, UserProfileWithCustomUser
...
admin.site.register(UserProfileWithCustomUser, UserProfileWithCustomUserAdmin)
